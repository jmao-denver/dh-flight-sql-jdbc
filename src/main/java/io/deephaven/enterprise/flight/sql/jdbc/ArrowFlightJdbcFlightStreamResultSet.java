...
import io.deephaven.enterprise.flight.sql.jdbc.client.CloseableEndpointStreamPair;
import io.deephaven.enterprise.flight.sql.jdbc.utils.FlightEndpointDataQueue;
import io.deephaven.enterprise.flight.sql.jdbc.utils.VectorSchemaRootTransformer;
...
public final class ArrowFlightJdbcFlightStreamResultSet
  ...
  private void loadNewQueue() {
    ...
    flightEndpointDataQueue = FlightEndpointDataQueue.createNewQueue(connection.getExecutorService());
  }
